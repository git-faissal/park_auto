              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Entrez votre Numero de telephone et votre mot de passe</p>
                  </div>

                  <form action="../controllers/verifierclient.php" method="post" enctype="application/x-www-form-urlencoded" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Vous n'avez pas de compte? <a href="pages-register.php">Creer un compte</a></p>
                    </div>
                  </form>
