        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>Pas dispo<sup style="font-size: 20px"></sup></h3>

                <p>Total moto stationner</p>
              </div>
              <div class="icon">
